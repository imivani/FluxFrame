// Silk fragment shader adapted from React Bits, Copyright 2026 David Haz.
// GLSL 300 / screen-space UV adapter; original pattern, noise and color preserved.
// See REACT-BITS-LICENSE.txt.
...
void main() {
  ...
  vec2  uv         = rotateUvs((gl_FragCoord.xy / u_resolution) * uScale, uRotation);
  vec2  tex        = uv * uScale;
  float tOffset    = uSpeed * u_time;
